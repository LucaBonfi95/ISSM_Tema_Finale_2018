...
public abstract class AbstractTemperature_sensor_adapter extends QActor { 
	...
	protected IActorAction action;
		...
		public AbstractTemperature_sensor_adapter(String actorId, QActorContext myCtx, IOutputEnvView outEnvView )  throws Exception{
			super(actorId, myCtx,  
			"./srcMore/it/unibo/temperature_sensor_adapter/WorldTheory.pl",
			setTheEnv( outEnvView )  , "init");
			this.planFilePath = "./srcMore/it/unibo/temperature_sensor_adapter/plans.txt";
	  	}
		@Override
		...
		*/    
	    ...
	    protected void initStateTable(){  	
	    	...
	    	stateTab.put("sendEvents",sendEvents);
	    }
	    StateFun handleToutBuiltIn = () -> {	
	    	try{	
	    		PlanRepeat pr = PlanRepeat.setUp("handleTout",-1);
	    		String myselfName = "handleToutBuiltIn";  
	    		println( "temperature_sensor_adapter tout : stops");  
	    ...
	    StateFun sendEvents = () -> {	
	    try{	
	     PlanRepeat pr = PlanRepeat.setUp(getName()+"_sendEvents",0);
	     pr.incNumIter(); 	
