%==============================================
% WorldTheory.pl for actor mock_output_temperature
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumock_output_temperature).	%%old version (deprecated)
actorobj(qatumock_output_temperature).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mock_output_temperature
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mock_output_temperature" ). 
...
%-------------------------------------------------
%  User static rules about mock_output_temperature
%------------------------------------------------- 
/*
------------------------------------------------------------------------
