%==============================================
% WorldTheory.pl for actor initial_conditions_checker
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuinitial_conditions_checker).	%%old version (deprecated)
actorobj(qatuinitial_conditions_checker).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor initial_conditions_checker
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of initial_conditions_checker" ). 
...
%-------------------------------------------------
%  User static rules about initial_conditions_checker
%------------------------------------------------- 
timeIsOk( true).
