%==============================================
% WorldTheory.pl for actor input_element
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuinput_element).	%%old version (deprecated)
actorobj(qatuinput_element).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor input_element
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of input_element" ). 
...
%-------------------------------------------------
%  User static rules about input_element
%------------------------------------------------- 
/*
------------------------------------------------------------------------
