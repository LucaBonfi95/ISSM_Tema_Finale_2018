%==============================================
% WorldTheory.pl for actor resource_model_time
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturesource_model_time).	%%old version (deprecated)
actorobj(qaturesource_model_time).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor resource_model_time
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of resource_model_time" ). 
...
%-------------------------------------------------
%  User static rules about resource_model_time
%------------------------------------------------- 
minTime( 7,0,0).
maxTime( 9,41,0).
changedModelAction( resource( name( timer),state( currentTime( CUR_H,CUR_M,CUR_S)))):-minTime( MIN_H,MIN_M,MIN_S),maxTime( MAX_H,MAX_M,MAX_S),sec_tot( ST_CUR,CUR_H,CUR_M,CUR_S),sec_tot( ST_MIN,MIN_H,MIN_M,MIN_S),sec_tot( ST_MAX,MAX_H,MAX_M,MAX_S),eval( ge,ST_CUR,ST_MIN),eval( ge,ST_MAX,ST_CUR), ! ,changeModelItem( timeIsOk,true).
changedModelAction( resource( name( timer),state( currentTime( CUR_H,CUR_M,CUR_S)))):-changeModelItem( timeIsOk,false).
/*
------------------------------------------------------------------------
