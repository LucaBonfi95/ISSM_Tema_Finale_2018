%==============================================
% WorldTheory.pl for actor mock_output_led
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumock_output_led).	%%old version (deprecated)
actorobj(qatumock_output_led).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mock_output_led
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mock_output_led" ). 
...
%-------------------------------------------------
%  User static rules about mock_output_led
%------------------------------------------------- 
ledName( led).
/*
------------------------------------------------------------------------
