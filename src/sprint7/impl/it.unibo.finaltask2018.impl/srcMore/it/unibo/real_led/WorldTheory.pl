%==============================================
% WorldTheory.pl for actor real_led
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatureal_led).	%%old version (deprecated)
actorobj(qatureal_led).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor real_led
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of real_led" ). 
...
%-------------------------------------------------
%  User static rules about real_led
%------------------------------------------------- 
ledName( led).
/*
------------------------------------------------------------------------
