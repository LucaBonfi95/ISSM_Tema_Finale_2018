%==============================================
% WorldTheory.pl for actor mock_sender
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumock_sender).	%%old version (deprecated)
actorobj(qatumock_sender).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mock_sender
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mock_sender" ). 
...
%-------------------------------------------------
%  User static rules about mock_sender
%------------------------------------------------- 
/*
------------------------------------------------------------------------
