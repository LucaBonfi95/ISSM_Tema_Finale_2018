%==============================================
% WorldTheory.pl for actor adapter_to_physical_mbot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuadapter_to_physical_mbot).	%%old version (deprecated)
actorobj(qatuadapter_to_physical_mbot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor adapter_to_physical_mbot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of adapter_to_physical_mbot" ). 
...
%-------------------------------------------------
%  User static rules about adapter_to_physical_mbot
%------------------------------------------------- 
/*
------------------------------------------------------------------------
