%==============================================
% WorldTheory.pl for actor resource_model_robot
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturesource_model_robot).	%%old version (deprecated)
actorobj(qaturesource_model_robot).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor resource_model_robot
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of resource_model_robot" ). 
...
%-------------------------------------------------
%  User static rules about resource_model_robot
%------------------------------------------------- 
changedModelAction( resource( name( robot),state( movement( stopped),obstacleDetected( true)))):- ! .
changedModelAction( resource( name( robot),state( X,obstacleDetected( true)))):-changeModelItem( robot,movement( stopped)).
/*
------------------------------------------------------------------------
