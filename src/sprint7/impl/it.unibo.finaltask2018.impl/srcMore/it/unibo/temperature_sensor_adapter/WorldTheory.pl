%==============================================
% WorldTheory.pl for actor temperature_sensor_adapter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutemperature_sensor_adapter).	%%old version (deprecated)
actorobj(qatutemperature_sensor_adapter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor temperature_sensor_adapter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of temperature_sensor_adapter" ). 
...
%-------------------------------------------------
%  User static rules about temperature_sensor_adapter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
