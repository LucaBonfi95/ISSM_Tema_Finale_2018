%==============================================
% WorldTheory.pl for actor stop_conditions_checker
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatustop_conditions_checker).	%%old version (deprecated)
actorobj(qatustop_conditions_checker).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor stop_conditions_checker
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of stop_conditions_checker" ). 
...
%-------------------------------------------------
%  User static rules about stop_conditions_checker
%------------------------------------------------- 
/*
------------------------------------------------------------------------
