%==============================================
% WorldTheory.pl for actor timer_adapter
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutimer_adapter).	%%old version (deprecated)
actorobj(qatutimer_adapter).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor timer_adapter
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of timer_adapter" ). 
...
%-------------------------------------------------
%  User static rules about timer_adapter
%------------------------------------------------- 
/*
------------------------------------------------------------------------
