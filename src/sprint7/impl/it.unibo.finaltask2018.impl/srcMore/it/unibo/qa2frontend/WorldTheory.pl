%==============================================
% WorldTheory.pl for actor qa2frontend
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuqa2frontend).	%%old version (deprecated)
actorobj(qatuqa2frontend).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor qa2frontend
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of qa2frontend" ). 
...
%-------------------------------------------------
%  User static rules about qa2frontend
%------------------------------------------------- 
/*
------------------------------------------------------------------------
