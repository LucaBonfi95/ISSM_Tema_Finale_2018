%==============================================
% WorldTheory.pl for actor resource_model_led
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturesource_model_led).	%%old version (deprecated)
actorobj(qaturesource_model_led).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor resource_model_led
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of resource_model_led" ). 
...
%-------------------------------------------------
%  User static rules about resource_model_led
%------------------------------------------------- 
/*
------------------------------------------------------------------------
