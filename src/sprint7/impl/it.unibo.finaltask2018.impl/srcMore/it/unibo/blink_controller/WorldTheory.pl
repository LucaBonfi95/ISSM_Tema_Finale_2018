%==============================================
% WorldTheory.pl for actor blink_controller
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatublink_controller).	%%old version (deprecated)
actorobj(qatublink_controller).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor blink_controller
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of blink_controller" ). 
...
%-------------------------------------------------
%  User static rules about blink_controller
%------------------------------------------------- 
ledName( led).
/*
------------------------------------------------------------------------
