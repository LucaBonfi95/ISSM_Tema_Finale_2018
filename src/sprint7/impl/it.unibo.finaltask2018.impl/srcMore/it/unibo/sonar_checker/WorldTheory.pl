%==============================================
% WorldTheory.pl for actor sonar_checker
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusonar_checker).	%%old version (deprecated)
actorobj(qatusonar_checker).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sonar_checker
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sonar_checker" ). 
...
%-------------------------------------------------
%  User static rules about sonar_checker
%------------------------------------------------- 
/*
------------------------------------------------------------------------
