%==============================================
% WorldTheory.pl for actor resource_model_sonar
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturesource_model_sonar).	%%old version (deprecated)
actorobj(qaturesource_model_sonar).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor resource_model_sonar
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of resource_model_sonar" ). 
...
%-------------------------------------------------
%  User static rules about resource_model_sonar
%------------------------------------------------- 
/*
------------------------------------------------------------------------
