%==============================================
% WorldTheory.pl for actor handle_planner
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuhandle_planner).	%%old version (deprecated)
actorobj(qatuhandle_planner).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor handle_planner
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of handle_planner" ). 
...
%-------------------------------------------------
%  User static rules about handle_planner
%------------------------------------------------- 
/*
------------------------------------------------------------------------
