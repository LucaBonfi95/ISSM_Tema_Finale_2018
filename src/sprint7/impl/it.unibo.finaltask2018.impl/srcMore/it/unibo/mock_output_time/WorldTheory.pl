%==============================================
% WorldTheory.pl for actor mock_output_time
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatumock_output_time).	%%old version (deprecated)
actorobj(qatumock_output_time).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor mock_output_time
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of mock_output_time" ). 
...
%-------------------------------------------------
%  User static rules about mock_output_time
%------------------------------------------------- 
/*
------------------------------------------------------------------------
