%==============================================
% WorldTheory.pl for actor frontend2qa
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatufrontend2qa).	%%old version (deprecated)
actorobj(qatufrontend2qa).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor frontend2qa
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of frontend2qa" ). 
...
%-------------------------------------------------
%  User static rules about frontend2qa
%------------------------------------------------- 
/*
------------------------------------------------------------------------
