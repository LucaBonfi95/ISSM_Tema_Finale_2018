%==============================================
% WorldTheory.pl for actor collision_detector
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatucollision_detector).	%%old version (deprecated)
actorobj(qatucollision_detector).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor collision_detector
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of collision_detector" ). 
...
%-------------------------------------------------
%  User static rules about collision_detector
%------------------------------------------------- 
/*
------------------------------------------------------------------------
