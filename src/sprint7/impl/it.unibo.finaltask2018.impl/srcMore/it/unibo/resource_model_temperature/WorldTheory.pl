%==============================================
% WorldTheory.pl for actor resource_model_temperature
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturesource_model_temperature).	%%old version (deprecated)
actorobj(qaturesource_model_temperature).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor resource_model_temperature
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of resource_model_temperature" ). 
...
%-------------------------------------------------
%  User static rules about resource_model_temperature
%------------------------------------------------- 
limitTemperatureValue( 25).
changedModelAction( resource( name( temp),state( temperature( VALUE)))):-limitTemperatureValue( MAX),eval( ge,MAX,VALUE), ! ,changeModelItem( temperatureIsOk,true).
changedModelAction( resource( name( temp),state( temperature( VALUE)))):-changeModelItem( temperatureIsOk,false).
/*
------------------------------------------------------------------------
