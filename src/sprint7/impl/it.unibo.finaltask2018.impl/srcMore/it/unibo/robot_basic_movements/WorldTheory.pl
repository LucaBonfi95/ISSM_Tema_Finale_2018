%==============================================
% WorldTheory.pl for actor robot_basic_movements
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobot_basic_movements).	%%old version (deprecated)
actorobj(qaturobot_basic_movements).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robot_basic_movements
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robot_basic_movements" ). 
...
%-------------------------------------------------
%  User static rules about robot_basic_movements
%------------------------------------------------- 
/*
------------------------------------------------------------------------
