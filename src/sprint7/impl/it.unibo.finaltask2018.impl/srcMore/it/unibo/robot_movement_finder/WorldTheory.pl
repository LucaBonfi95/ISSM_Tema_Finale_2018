%==============================================
% WorldTheory.pl for actor robot_movement_finder
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturobot_movement_finder).	%%old version (deprecated)
actorobj(qaturobot_movement_finder).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor robot_movement_finder
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of robot_movement_finder" ). 
...
%-------------------------------------------------
%  User static rules about robot_movement_finder
%------------------------------------------------- 
/*
------------------------------------------------------------------------
